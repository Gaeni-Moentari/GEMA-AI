...
class Agents:
    ...
    def BookSearch(self):
        Book = Agent(role='Book Searcher', 
                               goal="""Memberikan buku yang sesuai dari yang di minta pengguna dari perpustakaan Gbook""", 
                               backstory="""Kamu adalah seorang perpustakawan yang ahli mencari buku dengan cepat""", 
                               allow_delegation=False, 
                               verbose=True, 
                               llm=self.openaigpt4,
                               max_iter=2
